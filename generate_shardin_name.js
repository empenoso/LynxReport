 ...
 * 
 * Генерация pdf и html из списка статей в Гугл Таблице через библиотеку google-spreadsheet
 *
...
(async () => {
    ...
    var publications = '<!-- Начало вставки из сгенерированного файла generate_publications -->\n<ol>\n'
    ...
    var vegachart = `// Начало вставки из сгенерированного файла generate_google_charts_vegachart\n`
    for (var i = 2; i <= rows1.length + 1; i++) {
    ...
    fs.writeFileSync(`./generate_google_charts_vegachart.txt`, vegachart)
